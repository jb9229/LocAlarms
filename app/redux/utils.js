...
export const combineReducers = (reducers) => combReducers(objectMap(reducers, (val, key) => val.reducer ? (state, action) => handleActions(val.reducer, val.initialState)(state, {
  ...action,
