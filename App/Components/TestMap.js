...
import TestMapCallout from './TestMapCallout'
import Styles from './Styles/TestMapStyles'
...
class TestMap extends React.Component {
  ...
  *************************************************************/
  ...
  renderMapMarkers (location) {
    ...
    * Customize the callout in ./TestMapCallout.js
    *************************************************************/

    return (
      <MapView.Marker key={location.title} coordinate={{latitude: location.latitude, longitude: location.longitude}}>
        <TestMapCallout location={location} onPress={this.calloutPress} />
      </MapView.Marker>
    )
  }
